...
public class SolutionPanel extends JPanel {
	...
	private class GambitPanel extends SlotPanel {
		...
		protected void init() {
			add(cards[0], new GridBagConstraints(1, 0, 1, 1, 0.5, 0.5, 
					GridBagConstraints.CENTER, GridBagConstraints.NONE, 
					new Insets(5, 5, 5, 5), 0, 0));

			add(cards[1], new GridBagConstraints(2, 0, 1, 2, 0.5, 0.5, 
					GridBagConstraints.CENTER, GridBagConstraints.NONE, 
					new Insets(5, 5, 5, 5), 0, 0));
			
			add(cards[2], new GridBagConstraints(1, 1, 1, 1, 0.5, 0.5, 
					GridBagConstraints.CENTER, GridBagConstraints.NONE, 
					new Insets(5, 5, 5, 5), 0, 0));

			add(cards[3], new GridBagConstraints(0, 0, 1, 2, 0.5, 0.5, 
					GridBagConstraints.CENTER, GridBagConstraints.NONE, 
					new Insets(5, 5, 5, 5), 0, 0));
		}
	}
